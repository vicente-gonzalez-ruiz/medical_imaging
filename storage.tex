...
\begin{itemize}
\item A \glsentryshort{RAID} is a logical disk that is able to work even when
...
\item Files can be \popup{accessed randomly}{We can move over the file
to read or modify a part of it.}. Streams cannot (only are accessed
sequentially).
\end{itemize}
