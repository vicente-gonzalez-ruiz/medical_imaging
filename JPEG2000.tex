...
\begin{figure}[H]
  ...
  \begin{tabular}{cc}
    ...
    \includegraphics[width=4.5cm]{lena_01} & \includegraphics[width=4.5cm]{lena_01_jp2} \\
    JPEG & JPEG2000
  \end{tabular}
...
\begin{figure}[H]
  \vspace{-2ex}
  \centering
  \includegraphics[width=5.5cm]{2-level_wavelet_transform-lichtenstein}
...
\begin{figure}[H]
  \vspace{-2ex}
  \centering
  \href{https://flylib.com/books/en/2.537.1.37/1}{\includegraphics[width=10cm]{J2K_error_resilience}}
...
\begin{figure}[H]
  \vspace{-2ex}
  \centering
  \href{https://vicente-gonzalez-ruiz.github.io/JPEG2000/}{\includegraphics[width=7cm]{MJ2K}}
