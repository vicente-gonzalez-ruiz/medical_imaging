...
\section{Why?}
\begin{itemize}
\item Image registration is a digital image processing technique that
  helps us align different images (for example, \gls{CT} and \gls{MRI}
  of the same scene.
\item Another use is to do image averaging to increase the \gls{SNR}.
\end{itemize}
