...
\makeglossaries
\newacronym{TFT}{TFT}{\href{https://en.wikipedia.org/wiki/Thin-film_transistor}{Thin-Film Transistor}}
\newacronym{GI}{GI}{\href{https://en.wikipedia.org/wiki/Gastrointestinal_tract}{GastroIntestinal}}
\newacronym{SNR}{SNR}{\href{https://en.wikipedia.org/wiki/Signal-to-noise_ratio}{Signal-to-Noise Ratio}}
\newacronym{PNI}{PNI}{\href{https://www.radiologycafe.com/frcr-physics-notes/molecular-imaging/planar-imaging/}{Planar Nuclear Imaging}}
\newacronym{CT}{CT}{\href{https://en.wikipedia.org/wiki/CT_scan}{Computed Tomography}}
\newacronym{LAC}{LAC}{\href{https://en.wikipedia.org/wiki/Attenuation_coefficient}{Linear Attenuacion Coefficients}}
\newacronym{PET}{PET}{\href{https://en.wikipedia.org/wiki/Positron_emission_tomography}{Positron Emission Tomography}}
\newacronym{SPECT}{SPECT}{\href{https://en.wikipedia.org/wiki/Single-photon_emission_computed_tomography}{Single Photon Emission Computed Tomography}}
\newacronym{MRI}{MRI}{\href{https://en.wikipedia.org/wiki/Magnetic_resonance_imaging}{Magnetic Resonance Imaging}}
\newacronym{RF}{RF}{\href{https://en.wikipedia.org/wiki/Radio_frequency}{Radio Frequency}}
\newacronym{EM}{EM}{\href{https://en.wikipedia.org/wiki/Electromagnetic_radiation}{Electro Magnetic}}
...
\newacronym{DVD}{DVD}{\href{https://en.wikipedia.org/wiki/DVD}{Digital Versatile Disk}}
\newacronym{CD-ROM}{CD-ROM}{\href{https://en.wikipedia.org/wiki/CD-ROM}{Compact Disc - Read-Only Memory}}
\newacronym{DVD-ROM}{DVD-ROM}{Digital Versatile Disk - Read-Only Memory (see \gls{DVD})}
\newacronym{CD-R}{CD-R}{\href{https://en.wikipedia.org/wiki/CD-R}{Compact Disc - Recordable}}
\newacronym{CD-RW}{CD-RW}{\href{https://en.wikipedia.org/wiki/CD-RW}{Compact Disc - ReWritable}}
\newacronym{RAID}{RAID}{\href{https://en.wikipedia.org/wiki/RAID}{Redundant Array of Independent Disks}}
\newacronym{LAN}{LAN}{\href{https://en.wikipedia.org/wiki/Local_area_network}{Local Area Network}}
\newacronym{NAS}{\href{https://en.wikipedia.org/wiki/Network-attached_storage}{NAS}}{Network-Attached Storage}
\newacronym{HDD}{HDD}{\href{https://en.wikipedia.org/wiki/Hard_disk_drive}{Hard Disk Drive}}
\newacronym{SSD}{SSD}{\href{https://en.wikipedia.org/wiki/Solid-state_drive}{Solid State Drive}}
...
\newacronym{APNG}{APNG}{\href{https://en.wikipedia.org/wiki/APNG}{Animated PNG}}

\newacronym{JPEG}{JPEG}{\href{https://en.wikipedia.org/wiki/JPEG}{Joint Photographic Expert Group}}
\newacronym{ITU}{ITU}{\href{https://en.wikipedia.org/wiki/International_Telecommunication_Union}{International Telecommunication Union}}
