...
\begin{itemize}
\item Someting, we will deal with \popup{ill-posed problems}{Problem that
    does not have a finite number of solutions.}.
\item Examples (related with computer vision applications):
  \begin{enumerate}
  \item \href{https://en.wikipedia.org/wiki/Super-resolution_imaging}{Image super-resolution}.
  \item \href{https://en.wikipedia.org/wiki/Noise_reduction\#In_images}{Image denoising}.
  \item \href{https://en.wikipedia.org/wiki/Stereoscopy}{Stereoscopy using a single image}.
  \end{enumerate}
\end{itemize}
