...
\newacronym{YCbCr}{YCbCr}{{Y-luminance, blue-Chrominance, red-Chrominance}}
...
\newacronym{CIELAB}{CIELAB}{{CIE L*a*b*: L*-luminance, a*-chrominance, b*-chrominance}}
...
\newacronym{PEL}{PEL}{{Picture ELement}}
...
\item \textbf{Chatbot}: A Google
  \href{https://notebooklm.google.com/notebook/43ec7615-073d-4d48-9165-9b0142b46781?authuser=1}{NotebookLM} only for the contents
  of medical imaging.
...
\item \textbf{ImageJ}\footnote{\url{https://imagej.net}}: A open-source
  application to visualize and process 2D and 3D images.
\end{enumerate}
...
\bibliography{tomography,MRI,denoising,image_formats,X-rays,ultrasound,CT,radiology,storage,JPEG,JPEG2000,color_spaces,DICOM,vruiz,text_compression,image_processing,local}
