\chapter[\gls{CT}]{Computed\\Tomography (CT)}
\vspace{-43ex}
\begin{flushright}
...
\begin{figure}[!b]
  \centering
  \begin{tabular}{cc}
    \includegraphics[height=3.5cm]{CT_axis} & \includegraphics[height=4cm]{axial_coronal_sagittal}
  \end{tabular}
...
\begin{figure}[!b]
  \centering
  \begin{tabular}{cc}
    \includegraphics[height=3cm]{axial_scanning} & \includegraphics[height=3cm]{helical_scanning}
  \end{tabular}
...
\begin{figure}[!b]
  \centering
  \begin{tabular}{cc}
    \includegraphics[height=4cm]{Two_Squares_Phantom} & \includegraphics[height=4cm]{Sinogram_-_Two_Square_Indicator_Phantom}
  \end{tabular}
